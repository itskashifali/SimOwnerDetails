...
import {
    UfoneCallPackagesList,
  UfoneInternetPackagesList,
  UfoneSMSPackagesList,
} from '../../data/DummayData';

const UfonePackages = (props: any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {seletor == 0 ? (
        ...
        <Internet
          data={UfoneInternetPackagesList}
          onPress={(e: any) => {
            setCallData(e), refRBSheet.current.open();
          }}
        />
