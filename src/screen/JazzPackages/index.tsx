...
import {
  JazzCallPackagesList,
  JazzInternetPackagesList,
  JazzSMSPackagesList,
} from '../../data/DummayData';

const JazzPackages = (props: any) => {
