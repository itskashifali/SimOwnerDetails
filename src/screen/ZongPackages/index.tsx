...
import {
  ZongCallPackagesList,
  ZongInternetPackagesList,
  ZongSmsPackagesList,
} from '../../data/DummayData';

const ZongPackages = (props: any) => {
